...
public class ShuyunSign {
    ...
    public static void main(String[] args){
        ...
        String url = "http://api.shuyun.com/shuyun-searchapi/1.0/search";
        String body = "param={\"settings\":{\"data_source\":\"item_onsale\",\"pagination\":{\"offset\":0,\"limit\":1},\"return_format\":\"json\",\"query_id\":\"query_id_item_onsale\"},\"fields\":[\"num_iid\",\"title\",\"price\",\"detail_url\"],\"filters\":{\"type\":\"and\",\"fields\":[{\"type\":\"and\",\"fields\":[{\"type\":\"str_selector\",\"dimension\":\"num_iid\",\"value\":\"https://item.taobao.com/item.htm?id=537790782246\"}]}]}}";
        try {
            ListenableFuture<Response> future = client.preparePost(url)
